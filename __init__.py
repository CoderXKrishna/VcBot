...
from pyArank import HNDLR, LOGS, asst, udB, vcClient
from pyArank._misc._decorators import compile_pattern
...
from pyArank.fns.admins import admin_check
from pyArank.fns.tools import is_url_ok
from pyArank.fns.ytdl import get_videos_link
from pyArank._misc import owner_and_sudos, sudoers
from pyArank._misc._assistant import in_pattern
from pyArank._misc._wrappers import eod, eor
from pyArank.version import __version__ as UltVer
...
async def file_download(event, reply, fast_download=True):
    thumb = "https://telegra.ph/file/e594b8dfaea400858d01a.mp4"
